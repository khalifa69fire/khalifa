...
while attemps < 12345677901:
    ...
    if username == '2024' and password == '2025':
...
os.system('espeak -a 300 " Join,   My,  TELEGRAM,  EMON,  CRACKER"')
#LOGO
def banner():
	print("""%s
...
#MENU
def menu():
	os.system('xdg-open https://https://chat.whatsapp.com/BTErB7Oh2p3EtbcGB5h8it')
